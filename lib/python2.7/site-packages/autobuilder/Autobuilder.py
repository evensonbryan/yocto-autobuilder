...
class Autobuilder:
    ...
    def CreateExtraSchedulerParams(self, name=None, 
        ...
        if self.prop_type=="ChoiceStringParameter":
           self.schedprops.append(ChoiceStringParameter(name=self.name, 
                                             label=self.label, 
                                             required=self.required, 
                                             default=self.default,
                                             choices=self.choices))
        elif self.prop_type=="StringParameter":
           self.schedprops.append(StringParameter(name=self.name, 
                                             label=self.label, 
                                             required=self.required, 
                                             default=self.default,
                                             size=self.size))
        elif self.prop_type=="FixedParameter":
           self.schedprops.append(FixedParameter(name=self.name, 
                                             label=self.label, 
                                             required=self.required, 
                                             default=self.default))
