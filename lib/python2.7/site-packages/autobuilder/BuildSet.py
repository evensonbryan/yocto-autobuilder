                    ...
                    for x in stepOrder[step].iterkeys():
                        if x == 'schedulerNames':
                            ...
                            for scheduler in stepOrder[step][x]:
                                ...
                                for layer in layers:
                                    layername=layer.iterkeys().next()
                                    set_properties['repo_trigger_' + scheduler +"_"+ layername] = Property('repo_trigger_' + scheduler +"_"+ layername)
                                    set_properties['branch_trigger_' + scheduler +"_"+ layername] = Property('branch_trigger_' + scheduler +"_"+ layername)
                                    set_properties['bb_trigger_' + scheduler +"_"+ layername] = Property('bb_trigger_' + scheduler +"_"+ layername)
