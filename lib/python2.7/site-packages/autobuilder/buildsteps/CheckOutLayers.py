...
class CheckOutLayers (Source):
    ...
    def __init__(self, factory, layername=None, repourl=None, branch='HEAD', 
                mode='full', method='clobber', submodules=False, shallow=False, 
                progress=True, retryFetch=False, clobberOnFailure=False, 
                getDescription=False, argdict=None,
                 **kwargs):
        """
        @type  repourl: string
