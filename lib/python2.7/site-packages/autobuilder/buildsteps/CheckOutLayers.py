...
class CheckOutLayers(Git):
    def __init__(self, factory, scheduler=None, layername=None, mode='full', 
                method='clobber', submodules=False, shallow=False, srcdir='source', builddir='build',
        ...
        self.name="Git checkout of " + layername + " " + self.repourl
        kwargs['timeout']=self.timeout
        for k, v in argdict.iteritems():
            setattr(self, k, v)
        Git.__init__(self, repourl=self.repourl, branch=self.branch, mode=self.mode,
                 method=self.method, submodules=self.submodules, srcdir=self.srcdir+"/"+self.repourl,
                 builddir=self.builddir, shallow=self.shallow, progress=self.progress, 
