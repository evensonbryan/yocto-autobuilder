...
class TriggerBuilds():
    ...
    def __init__(self, factory, argdict=None, **kwargs):
        """
        argdict contents:
            "set_properties": {string:string} - dictionary of properties to send into the triggered builds.
            "schedulerNames": {string:{string:string}} - dictionary of schedulers with their property dictionaries
