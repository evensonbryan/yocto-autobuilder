...
class SyncPersistDB(ShellCommand):
    ...
    def start(self):
        ...
        if self.getProperty("repourl_poky") == "git://git.yoctoproject.org/poky" and os.environ.get('MAINTAIN_PERSISTDB') == "True":
            self.command = "cp -R " + os.environ.get('PERSISTDB_DIR') + "/" + self.buildername + \
