...
class GetDistroVersion(ShellCommand):
    """
    Build step to get the distribution version.
    Fails if the distribution is not pocky, oecore, or angstrom.
    """
    haltOnFailure = False
    flunkOnFailure = True
    ...
    def __init__(self, factory, argdict=None, **kwargs):
        """
        argdict contents:
            "distro": string - the distribution string
        """
    ...
    def start(self):
        ...
        distroconf=self.workerworkdir + "/" + buildername
