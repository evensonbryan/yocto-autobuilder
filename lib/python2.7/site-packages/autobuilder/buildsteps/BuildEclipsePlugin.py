...
class BuildEclipsePlugin(ShellCommand):
    ...
    def start(self):
        ...
        self.branch=self.getProperty("branch_eclipse-poky")
        eclipsehome=self.slaveworkdir + "/" + buildername 
        self.command='cd ' + self.eclipsedir + '/scripts/; ./setup.sh; ECLIPSE_HOME="' + eclipsehome + '/build/' + self.eclipsedir + '/scripts/eclipse" ./build.sh ' + self.branch + ' development'
