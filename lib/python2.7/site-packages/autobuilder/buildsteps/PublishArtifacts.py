    ...
    def start(self):
        ...
        if str(os.environ.get('PUBLISH_BUILDS')) == "True":
            for artifact in self.artifacts:
                if layerversion_yoctobsp is not None and int(layerversion_yoctobsp) > 1 and artifact == "atom-pc":
                    artifact = "genericx86"
                elif layerversion_yoctobsp is not None and int(layerversion_yoctobsp) < 2 and artifact == "genericx86":
                    artifact = "atom-pc"
                elif layerversion_yoctobsp is not None and int(layerversion_yoctobsp) < 2 and artifact == "genericx86_64":
                    artifact = "None"
