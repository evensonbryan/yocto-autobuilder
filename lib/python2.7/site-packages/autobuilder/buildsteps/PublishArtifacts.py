    ...
    def start(self):
        ...
        if str(os.environ.get('PUBLISH_BUILDS')) == "True":
            for artifact in self.artifacts:
                if int(layerversion_yoctobsp) > 1 and artifact == "atom-pc":
                    artifact = "genericx86"
                elif int(layerversion_yoctobsp) < 2 and artifact == "genericx86":
                    artifact = "atom-pc"
                elif int(layerversion_yoctobsp) < 2 and artifact == "genericx86_64":
                    artifact = "None"
