...
class CreateAutoConf(ShellCommand):
    ...
    def __init__(self, factory, argdict=None, **kwargs):
        ...
        self.adtdev=os.environ.get("ADTREPO_DEV_POPULATE")
    ...
    def start(self):
        ...
        if self.atext:
            ...
            try:
                ...
                pass
            log.msg(self.getProperty("commit_poky"))
            log.msg(self.getProperty("branch_poky"))
            log.msg(self.getProperty("distroversion"))

            if self.getProperty("commit_poky") == "HEAD" and self.getProperty("branch_poky") == "master" and self.getProperty("distroversion"):
                if self.adtdev == "True":
                    adtrepo_url=os.environ.get("ADTREPO_DEV_URL")
                    fout=fout+'ADTREPO = "' + adtrepo_url + '/' + self.getProperty("distroversion") + '-' + self.getProperty("got_revision_poky") + '"\n'
        if self.atextappend:
