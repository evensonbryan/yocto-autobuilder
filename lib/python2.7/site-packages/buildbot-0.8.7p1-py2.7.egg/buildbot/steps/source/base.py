...
class Source(LoggingBuildStep):
    ...
    def __init__(self, workdir=None,  storedir=None, mode='update', alwaysUseLatest=False,
                 timeout=100000, retry=None, env=None, logEnviron=True,
        ...
        @param storedir: directory used when mode='movecopy'. This moves
                        the tree into storage, in order for cron cleanup to occur.
