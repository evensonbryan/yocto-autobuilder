    ...
    def build_cxt(self, request, build):
        ...
        if build.getProperty("repourl_poky"):
            if build.getProperty("repourl_poky") == "git://git.yoctoproject.org/poky":
                cxt['repository'] = "poky"
                cxt['cgiturl'] = "http://git.yoctoproject.org/cgit/cgit.cgi/poky/log/?h="
            elif build.getProperty("repourl_poky") == "git://git.yoctoproject.org/poky-contrib":
                cxt['repository'] = "poky-contrib"
                cxt['cgiturl'] = "http://git.yoctoproject.org/cgit/cgit.cgi/poky-contrib/log/?h="
            else:
