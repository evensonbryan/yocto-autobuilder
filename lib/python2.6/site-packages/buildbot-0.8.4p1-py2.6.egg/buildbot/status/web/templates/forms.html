...
-->
  ...
  <div class="row">
    ...
    <hr />
  <div class="row">
     <span class="label">Clean Prior sstate:</span>
     <span class="field"><input type="hidden" name="property6name" value="cleansstate" /></span>
     <span class="field"><input type="radio" name="property6value" value="True"/></span>
  </div>
    <hr />
  <div class="row">
     <span class="label">Build Appliance SRCREV. Use AUTOREV to take HEAD:</span>
     <span class="field"><input type="hidden" name="property7name" value="buildappsrcrev" /></span>
     <input type='text' value="DEFAULT" name="property7value" value="True"/>
  </div>
